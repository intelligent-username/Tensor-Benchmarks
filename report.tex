...
\sisetup{
  ...
  input-symbols         = {skipped}, % allow non-numeric text
}

% token used to mark skipped numeric cells in tables
\newcommand{\skipped}{skipped}

\newcolumntype{d}[1]{S[table-format=#1,scientific-notation=true,table-number-alignment=center]}

% ---------- SPACING ----------
\setlength{\tabcolsep}{12pt}      % horizontal padding
\renewcommand{\arraystretch}{1.3} % vertical padding

% ---------- REPLACE 'skipped' WITH BLANK ----------
% Use pgfplotstable's built-in string replace feature in the table call below.
...
\begin{table}[H]
\makebox[\textwidth]{% ensures full horizontal centering
\pgfplotstabletypeset[
  col sep=comma,
  string type,
  header=has colnames,
  % string columns
  columns/Op/.style={string type},
  columns/Shape A/.style={string type},
  columns/Shape B/.style={string type},
  % numeric columns (S-type) will automatically have skip-dash
  columns/C/.style={column type=d{1.3e1}},
  columns/NumPy/.style={column type=d{1.3e1}},
  columns/PyTorch/.style={column type=d{1.3e1}},
  columns/Vanilla/.style={column type=d{1.3e1}},
  % styling
...
\pgfplotstabletypeset[
  ...
  columns/C/.style={
    column type=d{1.3e1},
    string replace={skipped}{--}
  },
  columns/NumPy/.style={
    column type=d{1.3e1},
    string replace={skipped}{--}
  },
  columns/PyTorch/.style={
    column type=d{1.3e1},
    string replace={skipped}{--}
  },
  columns/Vanilla/.style={
    column type=d{1.3e1},
    string replace={skipped}{--}
  },
  % styling
